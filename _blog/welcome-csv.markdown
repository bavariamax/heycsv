...
The standard "go-to" file format when it comes to exchanging structured data between companies or within large companies and its different IT systems still is in the year 2021 the CSV (comma separator values) file format. The reason is surely because it's so simple:
...
<div class="sib-form" style="text-align: center;
  ...
  <div id="sib-form-container" class="sib-form-container">
    ...
    <div id="sib-container" class="sib-container--large sib-container--vertical" style="text-align:center; background-color:rgba(255,255,255,1); max-width:540px; border-radius:3px; border-width:1px; border-color:#C0CCD9; border-style:solid;">
      <form id="sib-form" method="POST" action="https://b6ce3683.sibforms.com/serve/MUIEAGx9B-EnGkj4rYnbL_C2IqvEKez15K70EFzfPFoH4rPtDJk89BHBkHPLA2pkwhUq929C9BxNkPUmGAz587zCLmMY6Jpdg6LYY3SsiDRwlxtTaFqww1PF21WTw_DgEfsQ1hWVYtoe8j5dLU547Pe0vEDMiMzeTHACglQQmYVvl-Is-dbJir0U-kRNXfabq0acdeern9eTHxBZ"
              ...
              <div class="form__label-row ">
                <div class="entry__choice">
                  <label>
                    ...
                    <span class="checkbox checkbox_tick_positive"></span><span style="font-size:14px; text-align:left; font-family:&quot;Helvetica&quot;, sans-serif; color:#3C4858; background-color:transparent;"><p>I want to receive news about heycsv.com and accept the privacy policy. I can cancel the subscription any time in a link within every newsletter.</p></span>                    </label>
                </div>
              </div>
              <label class="entry__error entry__error--primary" style="font-size:16px; text-align:left; font-family:&quot;Helvetica&quot;, sans-serif; color:#661d1d; background-color:#ffeded; border-radius:3px; border-color:#ff4949;">
              </label>
...
<script>
  ...
  window.EMAIL_INVALID_MESSAGE = window.SMS_INVALID_MESSAGE = "This is invalid, pls make sure to give your email address in format name@email.com.";

  window.REQUIRED_ERROR_MESSAGE = "You cannot leave this field empty. ";

  window.GENERIC_INVALID_MESSAGE = "This is invalid, pls make sure to give your email address in format name@email.com.";
